...
def getGitHubAnalysis(projectID):
    ...
    if ((len(issuesOLengths) + len(issuesCLengths)) == 0):
        result = "No Issues"
        comment = "There are no issues in the code. It is important to fix issues as soon as they are found, to avoid them causing problems later."
    elif proportionalFixTime > 0.2:
